...
function SignupForm() {
  ...
  const { handleInputChange, validateField, errors } = useFormHandlers(
    state,
    dispatch
  );
        ...
        <section className={styles.inputs}>
          <form className={styles.inputs} onSubmit={submitForm}>
            <Input
              ...
              value={state.id}
              onChange={(e) =>
                handleInputChange(ActionType.SET_ID, e.target.value)
              }
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange(ActionType.SET_PASSWORD, e.target.value)
              }
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange(ActionType.SET_VERIFYPASSWORD, e.target.value)
              }
              onBlur={() =>
                validateField('verifyPassword', state.verifyPassword)
              }
              placeholder="비밀번호 확인"
              variant={'registerinput'}
            ...
            <Input
              ...
              onChange={(e) =>
                handleInputChange(ActionType.SET_NICKNAME, e.target.value)
              }
            ...
            <Input
              ...
              value={state.weight}
              onChange={(e) =>
                handleInputChange(ActionType.SET_WEIGHT, e.target.value)
              }
